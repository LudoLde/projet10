...
const Page = () => {
   ...
   const { data } = useData();
   const data1 = data?.events.sort((evtA, evtB) => (new Date(evtA.date) < new Date(evtB.date) ? 1 : -1));
   return (
      <>
         <header>
            <Menu />
            ...
            <section className="ServicesContainer">
               ...
               <div className="ListContainer">
                  ...
                  <ServiceCard imageSrc="/images/sophia-sideri-LFXMtUuAKK8-unsplash1.png">
                     ...
                     Notre agence experte en contenus immersifs offre des services de conseil aux entreprises, pour l’utilisation de la
                     réalité virtuelle, de la réalité augmentée et de la réalité mixte de l’animation événementielle, à la veille
         ...
         <footer className="row">
            <div className="col presta">
               ...
               {data1 && (
                  <EventCard imageSrc={data1[0]?.cover} title={data1[0]?.title} date={new Date(data1[0]?.date)} small label="boom" />
               )}
            </div>
            ...
            <div className="col description">
               <Logo size="large" />
               <p>
                  Une agence événementielle propose des prestations de service spécialisées dans la conception et l&apos;organisation de
                  divers événements tels que des événements festifs, des manifestations sportives et culturelles, des événements
                  professionnels
               </p>
            </div>
         </footer>
